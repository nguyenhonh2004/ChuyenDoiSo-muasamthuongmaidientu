...
function logIn(form) {
   ...
   var name = form.username.value;
    ...
    var newUser = { username: name, pass: pass }; // ✅ SỬA DÒNG NÀY
...
function signUp(form) {
  var newUser = {
        ...
        email: email,
        sdt: sdt,
        products: [], // Thêm thuộc tính này
        donhang: [],  // Thêm thuộc tính này
        off: false      // Thêm thuộc tính này
    };
...
function addHeader() {
	...
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/logo-dien-thoai-36.jpg" alt="Trang chủ Smartphone Store" title="Trang chủ Smartphone Store">
            </a>
        </div> <!-- End Logo -->
            ...
            <div class="tab-content">
                ...
                <div id="signup">
                    ...
                    <form onsubmit="return signUp(this);">
                        ...
                        <!-- ✅ Thêm khung nhập số điện thoại -->
                        <div class="field-wrap">
                            <label>
                                Số điện thoại<span class="req">*</span>
                            </label>
                            <input name="sdt" type="tel" pattern="[0-9]{10,11}" placeholder="" required autocomplete="off" />
                        </div> <!-- /sdt -->
